            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <select
                  ...
                  className="block w-full rounded-md border-0 bg-white/5 py-2.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 [&_*]:text-black"
                >
                  <option>Coffee chat</option>
                  <option>Job opportunity</option>
                  <option>Contract/Freelance project enquiry</option>
                  <option>Other</option>
                </select>
...
<div>
      ...
      <div className="mt-2">
        <textarea
          ...
          name="comment"
          id="comment"
          className="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6"
          defaultValue={''}
        />
       </div>
