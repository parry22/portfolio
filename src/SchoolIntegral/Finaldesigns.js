export default function Example() {
  ...
  className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"          aria-hidden="true"
          ...
          <div className="hidden sm:mt-32 sm:flex lg:mt-16">
                ...
                After adjusting everything based on user testing, I sent the designs to the developers. They were pleased to begin working on them, especially after the launch of Figma Dev Mode. With the MVP designs set, I shifted focus to the backlog features and ongoing iteration based on user feedback post-launch.
                </p>
