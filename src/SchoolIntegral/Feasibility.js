      ...
      <div className="relative isolate">
        ...
        <div className="py-24 sm:-py-24 lg:pb-10 -mt-24">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight text-white sm:-mt-20 sm:text-4xl">
            Tight Deadlines 🤝 Paper Wireframes
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Some designers might disagree but I believe paper wireframes are
            more efficient for tight deadlines. After creating a structural
            representation of our app and getting it approved, I started
            creating Hi-fidelity mockups.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6"></div>
        </div>
        <img
          src="SIwireframes.png"
          alt="App screenshot"
          width={2432}
          height={1442}
