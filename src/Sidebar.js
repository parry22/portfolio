      ...
      */}
      <div>
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex-grow flex-col gap-y-5 overflow-y-auto bg-gray-700 px-6 pb-2 ring-1 ring-white/10 rounded" style={{ opacity: 1 }}>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-700 px-6" style={{ opacity: 1 }}>
            <div className="flex h-16 shrink-0 items-center">
              <img
                className="h-8 w-auto"
                src="Logozz.svg"
              ...
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    ...
                    <span aria-hidden="true">Parry</span>
                  </a>
                </li>
              </ul>
            </nav>
