      ...
      <div className="relative isolate">
        ...
        <div className="py-24 sm:py-32 lg:pb-10">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Through the branding style guide I was provided, I made a robust
            design system in Figma, covering all the colour pallets,
            typographies, and components needed in my Figma design files and
            easy enough to maintain and scale in the future.{" "}
          </p>
